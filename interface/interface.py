...
class Main_Frame(wx.Frame):
    def __init__(self, parent):
        ...
        self.t_start = self.menu_toolbar.AddTool(
            wx.ID_ANY,
            "Start",
            wx.Bitmap("icons/24px/003-play-button.png", wx.BITMAP_TYPE_ANY),
            wx.NullBitmap,
            wx.ITEM_NORMAL,
            "Start acquisition",
            wx.EmptyString,
        ...
        self.t_stop = self.menu_toolbar.AddTool(
            wx.ID_ANY,
            "Stop",
            wx.Bitmap("icons/24px/005-stop.png", wx.BITMAP_TYPE_ANY),
            wx.NullBitmap,
            wx.ITEM_NORMAL,
            "Stop acquisition",
            wx.EmptyString,
        ...
        self.t_scr_sht = self.menu_toolbar.AddTool(
            wx.ID_ANY,
            "Screenshot",
            wx.Bitmap("icons/24px/007-camera.png", wx.BITMAP_TYPE_ANY),
            wx.NullBitmap,
            wx.ITEM_NORMAL,
            "Single shot",
            wx.EmptyString,
        ...
        self.t_vid = self.menu_toolbar.AddTool(
            wx.ID_ANY,
            "Video",
            wx.Bitmap("icons/24px/002-camera.png", wx.BITMAP_TYPE_ANY),
            wx.NullBitmap,
            wx.ITEM_CHECK,
        ...
        self.t_track = self.menu_toolbar.AddTool(
            wx.ID_ANY,
            "Track",
            wx.Bitmap("icons/24px/001-epicenter.png", wx.BITMAP_TYPE_ANY),
            wx.NullBitmap,
            wx.ITEM_CHECK,
            "Start/Stop tracking",
            wx.EmptyString,
        ...
        self.m_menubar1.Append(self.file_menu, "File")

        self.camera_menu = wx.Menu()
        self.opt_camera_menu = wx.MenuItem(
            self.camera_menu, wx.ID_ANY, "Options", wx.EmptyString, wx.ITEM_NORMAL
        )
        self.camera_menu.Append(self.opt_camera_menu)

        self.m_menubar1.Append(self.camera_menu, "Camera")

        self.help_menu = wx.Menu()
        self.m_menubar1.Append(self.help_menu, "Help")
        ...
        self.panel_cam = wx.Panel(
            self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL
        )
        bSizer1 = wx.BoxSizer(wx.VERTICAL)

        self.panel_cam_img = VideoView(
            self.panel_cam,
            wx.ID_ANY,
            wx.DefaultPosition,
            wx.DefaultSize,
        ...
        self.exp_slider = wx.Slider(
            ...
            wx.DefaultPosition,
            wx.DefaultSize,
            wx.SL_HORIZONTAL | wx.SL_MIN_MAX_LABELS | wx.SL_VALUE_LABEL,
        )
        bSizer14.Add(self.exp_slider, 1, wx.ALL | wx.ALIGN_BOTTOM, 5)

        self.exp_text = wx.SpinCtrlDouble(
            self.n_settings,
            wx.ID_ANY,
            "500000",
            wx.DefaultPosition,
        ...
        self.m_staticText2 = wx.StaticText(
            self.n_settings, wx.ID_ANY, "Gain:", wx.DefaultPosition, wx.DefaultSize, 0
        )
        ...
        self.gain_text = wx.SpinCtrlDouble(
            self.n_settings,
            wx.ID_ANY,
            "16",
            wx.DefaultPosition,
        ...
        self.m_staticText3 = wx.StaticText(
            self.n_settings, wx.ID_ANY, "FPS:", wx.DefaultPosition, wx.DefaultSize, 0
        )
        self.m_staticText3.Wrap(-1)

        bSizer3.Add(self.m_staticText3, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)

        self.fps_text = wx.SpinCtrlDouble(
            self.n_settings,
            wx.ID_ANY,
            wx.EmptyString,
            wx.DefaultPosition,
        ...
        bit_choiceChoices = ["4", "8"]
        self.bit_choice = wx.Choice(
            self.n_settings,
            wx.ID_ANY,
            wx.DefaultPosition,
            wx.DefaultSize,
        ...
        self.notebook.AddPage(self.n_settings, "Settings", False)
        self.n_stab_track = wx.Panel(
            self.notebook,
            wx.ID_ANY,
            wx.DefaultPosition,
            wx.Size(10, -1),
        ...
        self.m_button2 = wx.Button(
            self.n_stab_track, wx.ID_ANY, "Apply", wx.DefaultPosition, wx.DefaultSize, 0
        )
        ...
        self.time_bin = wx.SpinCtrlDouble(
            self.n_stab_track,
            wx.ID_ANY,
            wx.EmptyString,
            wx.DefaultPosition,
        ...
        self.line_len = wx.SpinCtrlDouble(
            self.n_stab_track,
            wx.ID_ANY,
            wx.EmptyString,
            wx.DefaultPosition,
        ...
        self.m_dirPicker21 = wx.DirPickerCtrl(
            self.n_stab_track,
            wx.ID_ANY,
            wx.EmptyString,
            "Select a folder",
        ...
        self.notebook.AddPage(self.n_stab_track, "Stability Tracking", True)
        self.n_rec = wx.Panel(
            self.notebook,
            wx.ID_ANY,
            wx.DefaultPosition,
        ...
        self.m_panel9 = wx.Panel(
            self.n_rec, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL
        )
        fgSizer4.Add(self.m_panel9, 1, wx.EXPAND | wx.ALL, 5)

        self.n_rec.SetSizer(fgSizer4)
        self.n_rec.Layout()
        self.notebook.AddPage(self.n_rec, "Rec.", False)

        bSizer131.Add(self.notebook, 1, wx.ALL | wx.EXPAND, 5)

        self.m_staticText12 = wx.StaticText(
            self, wx.ID_ANY, "Info Monitor:", wx.DefaultPosition, wx.DefaultSize, 0
        )
        self.m_staticText12.Wrap(-1)

        bSizer131.Add(self.m_staticText12, 0, wx.ALL, 5)

        self.info_monitor = wx.TextCtrl(
            self,
            wx.ID_ANY,
            wx.EmptyString,
            wx.DefaultPosition,
...
class Camera_Options_Frame(wx.Frame):
    def __init__(self, parent):
        ...
        cameras_listChoices = []
        self.cameras_list = wx.Choice(
            self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, cameras_listChoices, 0
        )
        self.cameras_list.SetSelection(0)
        bSizer13.Add(self.cameras_list, 0, wx.ALL | wx.EXPAND, 5)

        self.m_staticText14 = wx.StaticText(
            self, wx.ID_ANY, "Cameras backend:", wx.DefaultPosition, wx.DefaultSize, 0
        )
        self.m_staticText14.Wrap(-1)

        bSizer13.Add(self.m_staticText14, 0, wx.ALL, 5)

        backends_listChoices = ["MV Viewer (Dahua)", "OpenCV (DShow)", "VimbaX"]
        self.backends_list = wx.Choice(
            self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, backends_listChoices, 0
        )
