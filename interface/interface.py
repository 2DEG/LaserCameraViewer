...
class Main_Frame ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.line_len = wx.SpinCtrlDouble( self.n_stab_track, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.SP_ARROW_KEYS|wx.TE_PROCESS_ENTER, 0, 1000, 100, 1 )
		...
		self.show_ellps_chk = wx.CheckBox( self.n_stab_track, wx.ID_ANY, u"Show/Hide Ellipses", wx.DefaultPosition, wx.DefaultSize, 0 )
