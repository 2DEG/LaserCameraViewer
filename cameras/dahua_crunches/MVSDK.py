...
GENICAM_EProtocolType = enum(typeGigE=0, typeUsb3=1, typeCL=2, typePCIe=3, typeAll=255)
...
GENICAM_Camera_addRef = eval("CFUNCTYPE")(
    c_int, POINTER(GENICAM_Camera)
)  # 返回值 参数1 参数2 参数3 ......
...
GENICAM_Camera_loadDeviceCfg = eval("CFUNCTYPE")(
    c_uint,
    POINTER(GENICAM_Camera),
    c_char_p,
    POINTER(c_char * MAX_STRING_LENTH),
    POINTER(c_uint),
)
...
GENICAM_Camera._fields_ = [
    ...
    (
        "getInterfaceName",
        GENICAM_Camera_getInterfaceName,
    ),
...
GENICAM_System_discovery = eval("CFUNCTYPE")(
    c_int,
...
GENICAM_System_enumDevicesInfo = eval("CFUNCTYPE")(
    c_int,
    POINTER(GENICAM_System),
    POINTER(POINTER(GENICAM_DeviceInfo)),
    POINTER(c_uint),
    c_int,
)
GENICAM_System_createDevice = eval("CFUNCTYPE")(
    c_int,
    POINTER(GENICAM_System),
    POINTER(GENICAM_DeviceInfo),
    POINTER(POINTER(GENICAM_Camera)),
)
...
GENICAM_Frame_getPayLoadTypes = eval("CFUNCTYPE")(
    c_int, POINTER(GENICAM_Frame), c_int * MAX_PAYLOAD_TYPE_CNT, POINTER(c_uint)
)
GENICAM_Frame_getChunkCount = eval("CFUNCTYPE")(c_uint, POINTER(GENICAM_Frame))
GENICAM_Frame_getChunkDataByIndex = eval("CFUNCTYPE")(
    c_int,
    POINTER(GENICAM_Frame),
    c_uint,
    POINTER(c_uint),
    c_char * MAX_STRING_LENTH * MAX_PARAM_CNT,
    POINTER(c_uint),
)
...
GENICAM_StreamSource_stopGrabbing = eval("CFUNCTYPE")(
    c_int, POINTER(GENICAM_StreamSource)
)
GENICAM_StreamSource_isGrabbing = eval("CFUNCTYPE")(
    c_int, POINTER(GENICAM_StreamSource)
)
GENICAM_StreamSource_getFrame = eval("CFUNCTYPE")(
    c_int, POINTER(GENICAM_StreamSource), POINTER(POINTER(GENICAM_Frame)), c_uint
)
...
GENICAM_StreamSource_setInterPacketTimeout = eval("CFUNCTYPE")(
    c_int, POINTER(GENICAM_StreamSource), c_uint
)
GENICAM_StreamSource_setSingleResendMaxPacketNum = eval("CFUNCTYPE")(
    c_int, POINTER(GENICAM_StreamSource), c_uint
)
GENICAM_StreamSource_setMaxLostPacketNum = eval("CFUNCTYPE")(
    c_int, POINTER(GENICAM_StreamSource), c_uint
)
GENICAM_StreamSource_getStatisticsInfo = eval("CFUNCTYPE")(
    c_int, POINTER(GENICAM_StreamSource), POINTER(POINTER(GENICAM_StreamStatisticsInfo))
)
GENICAM_StreamSource_resetStatisticsInfo = eval("CFUNCTYPE")(
    c_int, POINTER(GENICAM_StreamSource)
)
...
GENICAM_GigECamera_getAccessPermission = eval("CFUNCTYPE")(
    c_int, POINTER(GENICAM_GigECamera)
)
GENICAM_GigECamera_getProtocolVersion = eval("CFUNCTYPE")(
    c_char_p, POINTER(GENICAM_GigECamera)
)
GENICAM_GigECamera_getIPConfiguration = eval("CFUNCTYPE")(
    c_char_p, POINTER(GENICAM_GigECamera)
)
...
GENICAM_UsbCamera_getConfigurationValid = eval("CFUNCTYPE")(
    c_char_p, POINTER(GENICAM_UsbCamera)
)
GENICAM_UsbCamera_getGenCPVersion = eval("CFUNCTYPE")(
    c_char_p, POINTER(GENICAM_UsbCamera)
)
...
GENICAM_UsbCamera_getU3VSerialNumber = eval("CFUNCTYPE")(
    c_char_p, POINTER(GENICAM_UsbCamera)
)
GENICAM_UsbCamera_isLowSpeedSupported = eval("CFUNCTYPE")(
    c_int, POINTER(GENICAM_UsbCamera)
)
GENICAM_UsbCamera_isFullSpeedSupported = eval("CFUNCTYPE")(
    c_int, POINTER(GENICAM_UsbCamera)
)
GENICAM_UsbCamera_isHighSpeedSupported = eval("CFUNCTYPE")(
    c_int, POINTER(GENICAM_UsbCamera)
)
GENICAM_UsbCamera_isSuperSpeedSupported = eval("CFUNCTYPE")(
    c_int, POINTER(GENICAM_UsbCamera)
)
...
GENICAM_UsbCamera_isDriverInstalled = eval("CFUNCTYPE")(
    c_int, POINTER(GENICAM_UsbCamera)
)
...
GENICAM_EnumNode_getEnumSymbolList = eval("CFUNCTYPE")(
    c_int, POINTER(GENICAM_EnumNode), POINTER(c_char * 256), POINTER(c_uint)
)  # ???
...
GENICAM_AcquisitionControl_acquisitionFrameRateEnable = eval("CFUNCTYPE")(
    GENICAM_BoolNode, POINTER(GENICAM_AcquisitionControl)
)
...
GENICAM_UserSetControl_restoreDefault = eval("CFUNCTYPE")(
    c_int, POINTER(GENICAM_UserSetControl)
)
...
GENICAM_UserSetControl_getCurrentUserSet = eval("CFUNCTYPE")(
    c_int, POINTER(GENICAM_UserSetControl)
)
